...
HD_PWD='/home/yang/vcu118/vcu118.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log U500VCU118DevKitFPGAChip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source U500VCU118DevKitFPGAChip.tcl -notrace
