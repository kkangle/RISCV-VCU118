...
HD_PWD='/home/yang/vcu118/vcu118.runs/vcu118mig_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vcu118mig.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vcu118mig.tcl
