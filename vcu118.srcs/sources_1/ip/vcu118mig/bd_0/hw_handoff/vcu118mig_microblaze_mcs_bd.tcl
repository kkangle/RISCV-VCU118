...
################################################################
# This is a generated script based on design: bd_28a7
#
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xcvu9p-flga2104-2L-e-es1
   set_property BOARD_PART xilinx.com:vcu118:part0:1.0 [current_project]
}


# CHANGE DESIGN NAME HERE
set design_name bd_28a7
